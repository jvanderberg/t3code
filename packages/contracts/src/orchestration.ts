...
export const CodexExecutionTarget = Schema.Union([
  Schema.Struct({
    type: Schema.Literal("local"),
  }),
  Schema.Struct({
    type: Schema.Literal("yolobox"),
    instanceName: TrimmedNonEmptyString,
  }),
]);
export type CodexExecutionTarget = typeof CodexExecutionTarget.Type;
export const CodexProviderStartOptions = Schema.Struct({
  binaryPath: Schema.optional(TrimmedNonEmptyString),
  homePath: Schema.optional(TrimmedNonEmptyString),
  executionTarget: Schema.optional(CodexExecutionTarget),
});
